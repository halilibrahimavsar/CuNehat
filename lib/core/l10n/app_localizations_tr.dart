...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get deleteBackupDesc => 'Google Drive\'daki yedek dosyası kalıcı olarak silinecek. Yerel veriniz etkilenmez.';
  ...
  @override
  String get dataExportImportDesc => 'Tam uygulama yedeği kaydedip geri yükleyin veya mevcut cüzdan işlemleri için CSV kullanın.';
  ...
  @override
  String get restoreFullBackupDesc => 'Bu işlem bu cihazdaki cüzdanları, işlemleri, birikimleri, borçları, alacakları, bütçeleri, tekrar eden işlem şablonlarını, kullanıcıları ve kategorileri değiştirir.';
  ...
  @override
  String get aylikTaksitKrediTutarindanKucuk => 'Aylık taksit × vade, kredi tutarından küçük olamaz';

  @override
  String get krediHesaplamaInfoBaslik => 'Banka kredisi hesaplaması';

  @override
  String get krediHesaplamaInfoGovde => '• Aylık taksiti biliyorum: Bankanın söylediği aylık taksiti yazın. Toplam geri ödeme = aylık taksit × vade. Kolaylık için alan, faizsiz bir başlangıç olarak kredi tutarı ÷ vade değerini önerir; kendi taksitinize göre değiştirin.\n\n• Faiz oranı ile: Bankanın aylık faiz oranını yazın. Taksit ve toplam, eşit taksitli kredi (amortisman) yöntemiyle hesaplanır.';
  ...
  @override
  String get islemBuguneAyarliIpucu => 'Tarih bugüne ayarlı — başka bir güne eklemek için tarihe dokun.';

  @override
  String get mevcutDegerAciklama => 'Yatırımın bugünkü piyasa değeri; \'Hesapla\' ile güncel fiyattan güncellenir.';
