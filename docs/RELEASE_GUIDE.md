...
| 3 | Gizlilik politikası yayında | ✅ **16 Eyl: ÇuHat adıyla yayında** — ölçüldü: `privacy-policy.html` → 200, "Son güncelleme: 16 Eylül 2026", metinde 17 kez ÇuHat. `RELEASE_GUIDE.html`, analiz dokümanı ve `store/` → 404 (sızıntı yok). **Mağaza adını değiştirmeden önce bu adım yapılır:** Play, politikanın mağazadaki adı ya da geliştiriciyi anmasını istiyor |
